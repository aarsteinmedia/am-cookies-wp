...
class AAMD_COOKIES_Rest_API
{
  ...
  {
    add_action('rest_api_init', [$this, 'aamd_cookies_register_options_rest_route']);
  }

  /**
   * Register Rest API Route for options page
   */
  public function aamd_cookies_register_options_rest_route()
  {
    register_rest_route(
      ...
      [
        'methods' => 'GET',
        'callback' => [$this, 'aamd_cookies_options_read_rest_route_callback'],
    ...
    register_rest_route(
      ...
      [
        'methods' => 'POST',
        'callback' => [$this, 'aamd_cookies_options_write_rest_route_callback'],
        'permission_callback' => '__return_true'
      ]
    );
  }
   ...
   */
  public function aamd_cookies_options_read_rest_route_callback($data)
  {
   ...
   */
  public function aamd_cookies_options_write_rest_route_callback($request)
  {
    if (!current_user_can('manage_options')) {
      return new WP_Error(
        'rest_write_error',
