!(function (t) {
	...
	function u() {
		if (!this.gdprContainer) return
		;(this.gdprContainer.innerHTML = `<div class="pop-up fadeIn" lang="${
	...
	function y({ disabled: t = !1, label: e, name: n, value: i }) {
		...
		return `<div class="container">${
			e ? `<label class="textLabel" for="${o}">${e}</label>` : ''
	...
	class S extends v {
		connectedCallback() {
			super.connectedCallback(),
				...
				(this.allowStatistical = b(w().analytics_storage)),
				(this.allowRetargeting = b(w().ad_storage)),
				...
				this.googleID?.startsWith('GTM-')
					...
					: this.googleID?.startsWith('G-') &&
					  ...
					  this.snapChatPixelID &&
							((this._snapChat = new z({
								snapChatPixelID: this.snapChatPixelID,
							})),
							(this.hasRetargeting = !0)),
					  this.tiktokPixelID &&
							((this._tikTok = new I({ tiktokPixelID: this.tiktokPixelID })),
							(this.hasRetargeting = !0))),
		...
		save() {
			let t = {
				ad_personalization: f(this.allowRetargeting),
				ad_storage: f(this.allowRetargeting),
				ad_user_data: f(this.allowStatistical),
				analytics_storage: f(this.allowStatistical),
				functionality_storage: 'granted',
				personalization_storage: f(this.allowRetargeting),
				security_storage: 'granted',
			}
			for (let e of (o.set(
				'CookieConsent',
		...
		render() {
			;(this.template.innerHTML = '<slot id="gdpr-container"></slot>'),
				(this.shadow.adoptedStyleSheets = [S.styles]),
	...
	'undefined' != typeof window &&
		window.document &&
		customElements.define('am-gdpr', S),
		(t.default = S),
		(t.tagName = 'am-gdpr'),
