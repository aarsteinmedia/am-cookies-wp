!(function (t) {
		...
		o = (function t(i, n) {
			function o(t, o, a) {
				if ('undefined' != typeof document) {
					...
					return (document.cookie = t + '=' + i.write(o, t) + s)
				}
			}
	...
	let a = (t) => {
			if (null != t) return t ? 'granted' : 'denied'
		},
		s = (t) => (null == t ? null : 'granted' === t),
		r = () => {
			let t = o.get('CookieConsent')
			return t
		...
		constructor() {
			...
			if (
				...
				'propertyChangedCallback' in this &&
					'function' == typeof this.propertyChangedCallback)
			)
				for (let e of t) {
					let t = this[e],
						i = Symbol(e)
					;(this[i] = t),
						Object.defineProperty(this, e, {
							...
							set(t) {
								let n = this[i]
								;(this[i] = t), this.propertyChangedCallback(e, n, t)
							},
						}),
						void 0 !== t &&
							d in this &&
							Array.isArray(this[d]) &&
							this[d].push(e)
				}
		}
		connectedCallback() {
			let t = []
			for (let e of (d in this && Array.isArray(this[d]) && (t = this[d]), t))
				'propertyChangedCallback' in this &&
					'function' == typeof this.propertyChangedCallback &&
					e in this &&
					this.propertyChangedCallback(e, void 0, this[e])
		}
	}
	var h =
			...
			i),
		u = (((n = {}).Banner = 'banner'), (n.Box = 'box'), n),
		p = {
			settings: 'Cookie-Einstellungen',
			customize: {
				header: 'Ihre Daten, Ihre Wahl',
				label: 'Anpassen',
				text: 'Wir verwenden <strong>funktionale Cookies</strong> f\xfcr die Navigation usw. Au\xdferdem verwenden wir <strong>statistische Cookies</strong>, um zu sehen, wie Benutzer mit der Website interagieren.',
				retargeting:
					'Wir verwenden auch <strong>Cookies f\xfcr Marketing.</strong>',
				link: 'Siehe unsere <a href="/%URL%">Datenschutzrichtlinie</a>',
			},
			header: 'Diese Website verwendet',
			miniGDPR: 'Cookie-Einstellungen',
			accept: 'Ich verstehe',
			acceptAll: 'Alle akzeptieren',
			decline: 'Nur funktionale',
			close: 'Schlie\xdfen',
			save: 'Einstellungen speichern',
			functional: { label: 'Funktional' },
			statistical: { label: 'Statistisch' },
		...
		m = {
			...
			customize: {
				header: 'Dine data, dit valg',
				label: 'Tilpas',
				text: 'Vi bruger <strong>funktionelle cookies</strong> til navigation osv. Derudover bruger vi <strong>statistiske cookies</strong> til at se, hvordan brugere interagerer med websitet.',
				retargeting:
					'Vi bruger ogs\xe5 <strong>cookies til marketing.</strong>',
				link: 'Se vores <a href="/%URL%">privatlivspolitik</a>',
			},
			header: 'Denne hjemmeside bruger',
			miniGDPR: 'Cookie-indstillinger',
			accept: 'Jeg forst\xe5r',
			acceptAll: 'Accepter alle',
			decline: 'Kun funktionelle',
			close: 'Luk',
			save: 'Gem pr\xe6ferencer',
			functional: { label: 'Funktionel' },
			statistical: { label: 'Statistisk' },
			marketing: { label: 'Marketing' },
			policyUrl: 'privatliv',
		},
		b = {
			...
			header: 'This website uses',
			miniGDPR: 'Cookie settings',
			accept: 'I understand',
		...
		f = {
			...
			customize: {
				header: 'Tus datos, tu elecci\xf3n',
				label: 'Personalizar',
				text: 'Utilizamos <strong>cookies funcionales</strong> para la navegaci\xf3n, etc. Adem\xe1s, utilizamos <strong>cookies estad\xedsticas</strong> para ver c\xf3mo los usuarios interact\xfaan con el sitio web.',
				retargeting:
					'Tambi\xe9n usamos <strong>cookies para marketing.</strong>',
				link: 'Consulta nuestra <a href="/%URL%">pol\xedtica de privacidad</a>',
			},
			header: 'Este sitio web utiliza',
			miniGDPR: 'Configuraci\xf3n de cookies',
			accept: 'Entiendo',
			acceptAll: 'Aceptar todo',
			decline: 'Solo funcional',
			close: 'Cerrar',
			save: 'Guardar preferencias',
			functional: { label: 'Funcional' },
			statistical: { label: 'Estad\xedstico' },
			marketing: { label: 'Marketing' },
			policyUrl: 'privacidad',
		},
		k = {
			settings: 'Ev\xe4steasetukset',
			customize: {
				header: 'Tietosi, valintasi',
				label: 'Mukauttaa',
				text: 'K\xe4yt\xe4mme <strong>toiminnallisia ev\xe4steit\xe4</strong> navigointiin jne. Lis\xe4ksi k\xe4yt\xe4mme <strong>tilastollisia ev\xe4steit\xe4</strong> n\xe4hd\xe4ksesi, miten k\xe4ytt\xe4j\xe4t vuorovaikuttavat verkkosivuston kanssa.',
				retargeting:
					'K\xe4yt\xe4mme my\xf6s <strong>markkinointiev\xe4steit\xe4.</strong>',
				link: 'Katso <a href="/%URL%">tietosuojak\xe4yt\xe4nt\xf6mme</a>',
			},
			header: 'T\xe4m\xe4 verkkosivusto k\xe4ytt\xe4\xe4',
			miniGDPR: 'Ev\xe4steasetukset',
			accept: 'Ymm\xe4rr\xe4n',
			acceptAll: 'Hyv\xe4ksy kaikki',
			decline: 'Vain toiminnalliset',
			close: 'Sulje',
			save: 'Tallenna asetukset',
			functional: { label: 'Toiminnallinen' },
			statistical: { label: 'Tilastollinen' },
			marketing: { label: 'Markkinointi' },
			policyUrl: 'tietosuoja',
		},
		w = {
			settings: 'Param\xe8tres des cookies',
			customize: {
				header: 'Vos donn\xe9es, votre choix',
				label: 'Personnaliser',
				text: 'Nous utilisons des <strong>cookies fonctionnels</strong> pour la navigation, etc. De plus, nous utilisons des <strong>cookies statistiques</strong> pour voir comment les utilisateurs interagissent avec le site Web.',
				retargeting:
					'Nous utilisons \xe9galement <strong>des cookies \xe0 des fins de marketing.</strong>',
				link: 'Consultez notre <a href="/%URL%">politique de confidentialit\xe9</a>',
			},
			header: 'Ce site Web est utilis\xe9',
			miniGDPR: 'Param\xe8tres des cookies',
			accept: 'Je comprends',
			acceptAll: 'Accepter tout',
			decline: 'Uniquement fonctionnel',
			close: 'Fermer',
			save: 'Enregistrer les pr\xe9f\xe9rences',
			functional: { label: 'Fonctionnel' },
			statistical: { label: 'Calcul statistique' },
			marketing: { label: 'Commercialisation' },
			policyUrl: 'confidentialite',
		},
		v = {
			settings: 'Cookieinnstillinger',
			customize: {
				header: 'Dine data, ditt valg',
				label: 'Tilpass',
				text: 'Vi bruker <strong>funksjonelle cookies</strong> til navigering og lignende. I tillegg bruker vi <strong>statistiske cookies</strong> til \xe5 se hvordan brukere interagerer med nettsiden.',
				retargeting:
					'Vi bruker ogs\xe5 <strong>cookies til markedsf\xf8ring.</strong>',
				link: 'Les mer p\xe5 v\xe5r <a href="/%URL%">personvernserkl\xe6ring</a>',
			},
			header: 'Denne nettsida bruker',
			miniGDPR: 'Innstillinger for cookies',
			accept: 'Jeg forst\xe5r',
			acceptAll: 'Godta alle',
			decline: 'Bare funksjonelle',
			close: 'Lukk',
			save: 'Lagre innstillinger',
			functional: { label: 'Funksjonell' },
			statistical: { label: 'Statistisk' },
			marketing: { label: 'Markedsf\xf8ring' },
			policyUrl: 'personvern',
		},
		y = {
			settings: 'Cookie-inst\xe4llningar',
			customize: {
				header: 'Dina uppgifter, ditt val',
				label: 'Anpassa',
				text: 'Vi anv\xe4nder <strong>funktionella cookies</strong> f\xf6r navigering, etc. Dessutom anv\xe4nder vi <strong>statistiska cookies</strong> f\xf6r att se hur anv\xe4ndare interagerar med webbplatsen.',
				retargeting:
					'Vi anv\xe4nder ocks\xe5 <strong>cookies f\xf6r marknadsf\xf6ring.</strong>',
				link: 'Se v\xe5r <a href="/%URL%">integritetspolicy</a>',
			},
			header: 'Denna webbplats anv\xe4nder',
			miniGDPR: 'Cookie-inst\xe4llningar',
			accept: 'Jag f\xf6rst\xe5r',
			acceptAll: 'Acceptera allt',
			decline: 'Endast funktionella',
			close: 'St\xe4ng',
			save: 'Spara inst\xe4llningar',
			functional: { label: 'Funktionell' },
			statistical: { label: 'Statistisk' },
			marketing: { label: 'Marknadsf\xf6ring' },
			policyUrl: 'integritet',
		}
	let x = document.documentElement.lang.toLowerCase() || 'en',
		C =
			['de', 'dk', 'en', 'es', 'fin', 'fr', 'nb', 'no', 'sv'].find((t) =>
				x.includes(t)
			) || 'en'
	function _() {
		switch (C) {
	...
	function S() {
		...
		let {
			acceptAll: t,
			close: e,
			customize: { header: i, link: n, retargeting: o, text: a },
			decline: s,
			functional: { label: r },
			marketing: { label: l },
			policyUrl: c,
		...
		this.gdprContainer.innerHTML = `<div class="pop-up fade-in" lang="${
			document.documentElement.lang
		}"><dialog open>${(function ({ ariaLabel: t, className: e, isOpen: i }) {
			return `<button ariaLabel="${t}" class="menu-button ${e}" data-open="${i}"><span class="hamburger"><span></span></span></button>`
		})({
			ariaLabel: e,
			className: 'close-button',
			isOpen: !0,
		})}<div class="dialog-inner-box" style="display:flex;flex-direction:column"><h3><figure aria-label="cookies" class="icon-cookies" style="display:inline-flex;margin-right:.5em">${D}</figure>${i}</h3><p>${a}${
			this.hasRetargeting ? ` ${o}` : ''
		}</p><p>${n.replace(
			'%URL%',
			this.privacyPolicyURL || c
		)}</p><div id="save-wrapper" class="button-wrapper"><button class="button gdpr decline-all" style="background-color:transparent">${s}</button> <button class="button gdpr accept-all">${t}</button></div><div class="button-wrapper">${this.switchButton(
			{ disabled: !0, label: r, name: 'functional', value: !0 }
		)} ${this.switchButton({
			label: g,
		...
		let h = this.gdprContainer.querySelector('#save-wrapper'),
			u = document.createElement('button')
		;(u.innerText = d),
			(u.className = 'button gdpr save'),
			(u.onclick = () => {
				this.save(), (this.isCustomize = !1), (this.isVisible = !1)
			})
		let p = this.gdprContainer.querySelector('[name="allowStatistical"]')
		p instanceof HTMLInputElement &&
			(p.onchange = (t) => {
				h?.replaceChildren(u), this.handleChange(t, this)
			})
		let m = this.gdprContainer.querySelector('[name="allowRetargeting"]')
		m instanceof HTMLInputElement &&
			(m.onchange = (t) => {
				h?.replaceChildren(u), this.handleChange(t, this)
			})
		let b = this.gdprContainer.querySelector('.accept-all')
		b instanceof HTMLButtonElement && (b.onclick = this.acceptAll)
		let f = this.gdprContainer.querySelector('.decline-all')
		f instanceof HTMLButtonElement && (f.onclick = this.declineAll)
		let k = this.gdprContainer.querySelector('.close-button')
		k instanceof HTMLButtonElement && (k.onclick = () => this.setCustomize(!1)),
			setTimeout(() => {
				let t = this.gdprContainer?.querySelector('dialog'),
					e = this.gdprContainer?.querySelector('.dialog-inner-box')
				if (!(t instanceof HTMLDialogElement) || !(e instanceof HTMLElement))
					return
				let i = `${(e.offsetHeight ?? 0) + 80}px`
				Object.assign(t.style, { maxHeight: i, minHeight: i })
			}, 10)
	}
	function P({ disabled: t = !1, label: e, name: i, value: n }) {
		let o = c()
		return `<div class="container">${
			e ? `<label class="text-label" for="${o}">${e}</label>` : ''
		} <label class="label"><input ${n ? 'checked' : ''} class="input" ${
			t ? 'disabled' : ''
		} id="${o}" name="${i}" type="checkbox" value="${n}"> <span class="slider"></span></label></div>`
	}
	class E {
		constructor({ config: t = {}, consentParams: e, googleID: i }) {
			;(this._initialized = !1),
				(this.config = {}),
				(this.googleID = i),
				(this.config = t),
				(this.consentParams = e),
				window.gtag ||
		...
		initialize() {
			...
			let t = 'ga-gtag'
			if (!document.getElementById(t) && !this._initialized)
				try {
					if (!this.googleID) throw Error('No Google Tag ID was assigned')
					let e = document.createElement('script')
					;(e.id = t),
						(e.async = !0),
						(e.src = `https://www.googletagmanager.com/gtag/js?id=${this.googleID}`),
		...
		updateConsent({ consentParams: t }) {
			try {
				window.gtag('consent', 'update', t)
			} catch (t) {
				console.error(t)
			}
		}
	...
	let I = (t, e, i) =>
		`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.id='gtm-snippet';j.${
			e ? 'defer' : 'async'
		}=true;j.src='https://${i}/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','${t}');`
	class L {
		constructor({
			consentParams: t,
			defer: e = !1,
			gtmId: i,
			serverSideDomain: n = null,
		}) {
			;(this._initialized = !1),
				(this.gtmId = null),
				(this.serverSideDomain = null),
				(this.defer = !1),
				(this.gtmId = i ? i.trim() : null),
				(this.serverSideDomain = n ? n.trim() : null),
				(this.defer = !!e),
				(this.consentParams = t),
				window.gtag ||
					(window.gtag = function () {
						;(window.dataLayer = window.dataLayer || []),
							window.dataLayer.push(arguments)
		...
		initialize() {
			if ((gtag('consent', 'default', this.consentParams), this._initialized)) {
			...
			let t = document.getElementById('gtm-snippet')
			if (
				!(
					t &&
					'src' in t &&
					'string' == typeof t.src &&
					t.src.includes(`id=${this.gtmId}`)
				)
			) {
	...
	class A {
		constructor({ locale: t = 'en_US', metaPixelID: e }) {
			;(this._initialized = !1),
				(this.metaPixelID = e),
				(this.locale = t.replaceAll('-', '_'))
		}
		initialize() {
			let t = 'meta-pixel'
			if (!document.getElementById(t) && !this._initialized)
				try {
					if (!this.metaPixelID) throw Error('No Meta Pixel ID was assigned')
					let e = document.createElement('script')
					;(e.id = t),
	...
	class R {
		constructor({ snapChatPixelID: t }) {
			;(this._initialized = !1), (this.snapChatPixelID = t)
		}
		initialize() {
			let t = 'snap-pixel'
			if (!document.getElementById(t) && !this._initialized)
	...
	class M {
		constructor({ tiktokPixelID: t }) {
			;(this._initialized = !1), (this.tiktokPixelID = t)
		}
		initialize() {
			let t = 'snap-pixel'
			if (!document.getElementById(t) && !this._initialized)
				try {
					if (!this.tiktokPixelID)
						throw Error('No TikTok Pixel ID was assigned')
					let e = document.createElement('script')
					;(e.id = t),
	...
	class q extends g {
		constructor() {
			super(),
				...
				(this.hasRetargeting = !1),
				(this._popUp = S),
				(this._cookieWarning = z),
				(this._miniGDPR = T),
				(this.switchButton = P),
		...
		connectedCallback() {
			super.connectedCallback(),
				...
				(this.allowStatistical = s(r().analytics_storage)),
				(this.allowRetargeting = s(r().ad_storage)),
				(this.gdprContainer = this.shadow.querySelector('#gdpr-container')),
				(this.isCustomize ||
					this.allowStatistical ||
					!1 === this.allowStatistical) &&
				!this.isVisible &&
				o.get('CookieConsent')
					? this.isCustomize
						? this._popUp()
						: this._miniGDPR()
					: this._cookieWarning(),
				this.googleID?.startsWith('GTM-')
					? ((this._gtm = new L({ consentParams: r(), gtmId: this.googleID })),
					  (this.hasRetargeting = !0))
					: this.googleID?.startsWith('G-') &&
					  ((this._gTag = new E({
							consentParams: r(),
					  ...
					  this.metaPixelID &&
							...
							(this.hasRetargeting = !0)),
					  this.snapChatPixelID &&
							((this._snapChat = new R({
								snapChatPixelID: this.snapChatPixelID,
							})),
							(this.hasRetargeting = !0)),
					  this.tiktokPixelID &&
							((this._tikTok = new M({ tiktokPixelID: this.tiktokPixelID })),
							(this.hasRetargeting = !0))),
				...
				this._gtm &&
					(this._meta || this._snapChat || this._tikTok) &&
					console.warn('Consider moving tags into Google Tag Manager'),
				(window.addGDPRConsent = (t) => {
					this._consentListeners.push(t)
				})
			let t = this.shadowRoot?.adoptedStyleSheets[0]
			setTimeout(() => {
				t?.insertRule(
					`:host{--border-width: ${this.borderWidth}px;--font-family: ${this.fontFamily};--color: ${this.color};--background-color: ${this.backgroundColor};--accent-color: ${this.accentColor};}`
				)
			}, 0),
				this._debug()
		}
			...
			if (this.shadow && this.gdprContainer)
				switch (t) {
					case 'isCustomize':
						...
						break
					case 'isSaving': {
						let t = this.gdprContainer.querySelector('.accept-all')
						i &&
					...
					case 'allowStatistical': {
						let t = this.gdprContainer.querySelector(
							'[name="allowStatistical"]'
						)
						t instanceof HTMLInputElement && (t.checked = !!i)
						break
					}
					...
					case 'isVisible':
						if (this.isCustomize) break
						i ? this._cookieWarning() : this._miniGDPR()
						break
					case '_text':
						o.get('CookieConsent') ? this._miniGDPR() : this._cookieWarning()
				}
		}
		set googleID(t) {
			this.setAttribute('googleID', t || '')
		}
		get googleID() {
			return this.getAttribute('googleID')
		}
		set metaPixelID(t) {
			this.setAttribute('metaPixelID', t || '')
		}
		get metaPixelID() {
			return this.getAttribute('metaPixelID')
		}
		set snapChatPixelID(t) {
			this.setAttribute('snapChatPixelID', t || '')
		}
		get snapChatPixelID() {
			return this.getAttribute('snapChatPixelID')
		}
		set tiktokPixelID(t) {
			this.setAttribute('tiktokPixelID', t || '')
		}
		get tiktokPixelID() {
		...
		set accentColor(t) {
			this.setAttribute('accentColor', t)
		}
		get accentColor() {
		...
		set borderWidth(t) {
			this.setAttribute('borderWidth', t.toString())
		}
		get borderWidth() {
			return Number(this.getAttribute('borderWidth') ?? 2)
		}
		set alignPrompt(t) {
			this.setAttribute('alignPrompt', t)
		}
		get alignPrompt() {
			let t = this.getAttribute('alignPrompt')
			return t && Object.values(h).includes(t) ? t : h.BottomLeft
		}
		set alignMiniPrompt(t) {
			this.setAttribute('alignMiniPrompt', t)
		}
		get alignMiniPrompt() {
			let t = this.getAttribute('alignMiniPrompt')
			return t && Object.values(h).includes(t) ? t : h.BottomLeft
		}
		set format(t) {
		...
		get format() {
			...
			return t && Object.values(u).includes(t) ? t : u.Box
		}
		set privacyPolicyURL(t) {
			this.setAttribute('privacyPolicyURL', t || 'privacy')
		}
		...
		save() {
			let t = {
				ad_personalization: a(this.allowRetargeting),
				ad_storage: a(this.allowRetargeting),
				ad_user_data: a(this.allowStatistical),
				analytics_storage: a(this.allowStatistical),
				functionality_storage: 'granted',
				personalization_storage: a(this.allowRetargeting),
				security_storage: 'granted',
			}
			for (let e of (o.set(
				'CookieConsent',
			...
			this._gtm?.updateConsent({ consentParams: r() }),
			this._gTag?.updateConsent({ consentParams: r() }),
			this.allowRetargeting &&
				(this._meta?.initialize(),
				this._snapChat?.initialize(),
				this._tikTok?.initialize()),
		...
		acceptAll() {
			let t = {
				retargeting: !!this.hasRetargeting && this.allowRetargeting,
				statistical: this.allowStatistical,
			}
			;(this.allowStatistical = !0),
				...
				setTimeout(
					...
					!this.isCustomize || (t.statistical && t.retargeting) ? 0 : 800
				),
				(window.dataLayer && window.google_tag_data) ||
					(this._gtm?.initialize(), this._gTag?.initialize()),
				this.save(),
				this._debug()
		}
		declineAll() {
			;(this.isCustomize = !1),
				(this.isVisible = !1),
				(this.allowStatistical = !1),
				(this.allowRetargeting = !1),
				this._debug(),
				this.save()
		}
		esc({ key: t }) {
			this.isCustomize && 'Escape' === t && this.setCustomize(!1)
		}
		setCustomize(t) {
			;(this.isCustomize = !!t),
				(this.isVisible = !t),
		...
		handleChange({ target: t }, e) {
			if (t instanceof HTMLInputElement) {
				let { checked: i, name: n } = t
				n in e && 'boolean' == typeof e[n] && (e[n] = i)
			}
			this._debug()
		}
		setVisible() {
			o.remove('CookieConsent'),
				(this.allowStatistical = null),
				(this.allowRetargeting = null),
				(this.isVisible = !0),
				this._debug()
		...
		hideOnScroll() {
			let t = document.body.getBoundingClientRect(),
				e = this.gdprContainer?.querySelector('.mini-gdpr')
			e instanceof HTMLButtonElement &&
				((e.dataset.hide = (t.top < this._scrollPos && t.top < -20).toString()),
				(this._scrollPos = t.top))
		}
		_addEventListeners() {
		...
		render() {
			;(this.template.innerHTML = '<slot id="gdpr-container"></slot>'),
				(this.shadow.adoptedStyleSheets = [q.styles]),
				this.shadow.appendChild(this.template.content.cloneNode(!0))
		}
	}
	'undefined' != typeof window &&
		window.document &&
		!customElements.get('am-cookies') &&
		customElements.define('am-cookies', q),
		(t.default = q),
		(t.tagName = 'am-cookies'),
