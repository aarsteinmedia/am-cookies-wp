...
if (!class_exists('AM_Cookies_Admin')) {

  class AM_Cookies_Admin
  {
    ...
    public function admin_enqueue_scripts($page)
    {
      wp_enqueue_style(
        ...
        AM_COOKIES_URL . 'styles/admin.css',
        [],
        '1.0.0'
      );
      wp_enqueue_style(
        'am-gdpr-preview-style',
        AM_COOKIES_URL . 'styles/preview.css',
        [],
        '1.0.0'
      );
      wp_enqueue_style('wp-edit-blocks');

      $assets = require AM_COOKIES_PATH . 'build/settings.asset.php';

      if ($page === 'toplevel_page_am-cookies') {
        wp_enqueue_script(
          'am-cookies-options',
          AM_COOKIES_URL . 'build/settings.js',
          $assets['dependencies'],
          '1.00',
          true
        );
 ...
 * @return AM_Cookies_Admin
 */
(function () {
  global $am_cookies_admin;

  if (!isset($am_cookies_admin)) {
    $am_cookies_admin = new AM_Cookies_Admin();
  }
